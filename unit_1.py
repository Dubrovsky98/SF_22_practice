...
@pytest.fixture(scope='function', params=[('Короткая строка', 'Короткая строка'),
...
('Длинная строка нам достаточно будет для проверки и в ней есть слово python', 'Длинная строка нам достаточно будет для проверки и в ней есть слово python')],
                ids=generate_id)
